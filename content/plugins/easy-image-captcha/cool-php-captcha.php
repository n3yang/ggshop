...
/**
 * CoolPhpCaptcha class
 *
 */
class CoolPhpCaptcha {
...
class EasyImageCaptcha extends CoolPhpCaptcha
{
    /** Dictionary word file (empty for random text) */
    public $wordsFile = '';
     ...
     */
    public $fonts = array(
        '1' => array('spacing' => -3, 'minSize' => 18, 'maxSize' => 23, 'font' => '1.ttf'),
        '2' => array('spacing' => -1, 'minSize' => 18, 'maxSize' => 23, 'font' => '2.ttf'),
        '4' => array('spacing' => -2, 'minSize' => 20, 'maxSize' => 23, 'font' => '4.ttf'),
        '5' => array('spacing' => 1, 'minSize' => 16, 'maxSize' => 22, 'font' => '5.ttf'),
        '6' => array('spacing' => -1, 'minSize' => 14, 'maxSize' => 20, 'font' => '6.ttf'),
    );

    /** Sessionname to store the original text */
    public $session_var = 'eic_session_var';

    /* verify code type: number or text */
    public $captchaType = 'number';
    ...
    protected function GetCaptchaText() {
        ...
        if ($this->captchaType == 'number') {
            return substr(rand(1000000000, 9999999999), 0, $this->maxWordLength);
        }
        $text = $this->GetDictionaryCaptchaText();
        if (!$text) {
            $text = $this->GetRandomCaptchaText();
    ...
    */
    public function check($code){
        return $_SESSION[$this->session_var] == $code ? true : false;
    }
