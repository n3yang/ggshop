	<div class="main">
		<div class="banner">
			<div id="ui-slide">
		        <ul class="slide">
		            <li class="slide-panel" data-pic="<?php bloginfo('template_url'); ?>/images/banner-0730.jpg">
		                <div class="slide-pic">
		             		<a style="position:absolute;width:1200px;height:367px;" href="category/presales"></a>
		                </div>
		            </li>
